...
{
	public class QILPostProcessor: ILPostProcessor
	{
		public static List<DiagnosticMessage> Logs = new List<DiagnosticMessage>();
		public static AssemblyDefinition Assembly => Resolver.selfAssembly;
		public static QAssemblyResolver Resolver { get; private set; }
	...
	public static class QCodeGenTool
	{
		...
		public static MethodReference GetMethod(this AssemblyDefinition assembly, Type type, string methodName=".ctor", int paramCount = -1)
		{
		...
		public static void As(this ILProcessor iL,TypeReference type)
		{
